      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-16 py-16 backdrop-blur-sm bg-white/70 rounded-2xl shadow-lg">
        ...
        <div className="mt-12 ">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            with hands-on experience building scalable and efficient full-stack
            applications. <br />✅ Experienced with Git, REST APIs, Tailwind
            CSS, and Firebase, ensuring smooth version control, seamless
            integrations, and modern UI/UX development. <br /> ✅ Strong grasp
            of design principles and responsive layouts, enabling the creation
            of visually appealing, user-friendly, and mobile-first interfaces.{" "}
            <br /> ✅ Excellent problem-solving and debugging skills, with the
            ability to identify issues quickly and implement effective,
            long-term solutions. <br /> ✅ Effective communicator and
            collaborative team player, capable of working across diverse teams
            to deliver projects on time and with high quality.
          </ul>
        </div>

  ...
  return (
    <div name="Experience">
      <div className="max-w-screen-2xl container mx-auto px-12 md:px-20 my-0 ">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 space-x-4 space-y-3 mt-4">
          {cardItem.map(({ id, logo, name, link }) => (
            <a
              ...
              className="bg-white md:w-[160px] md:h-[160px] w-[140px] h-[140px]  space-x-1 rounded-full px-10 md:py-2 shadow-xl cursor-pointer hover:scale-110 duration-300 flex flex-col items-center justify-center text-center"
            >
              <img
                src={logo}
                alt={name}
